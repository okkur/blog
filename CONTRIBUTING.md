...
Thank you for your interest in contributing to Okkur Labs Blog.  
This guide helps make contributing to Okkur Labs Blog simple and efficient for everyone.

### First contribution

If you are starting out contributing to Okkur Labs Blog, there might be smaller scoped "starter issues" available:
[Current starter issues](https://github.com/okkur/blog/labels/starter%20issue)
...
As your time is precious and not all features might be in the scope of what the Okkur Labs Blog wants to achieve, please open up an issue first.
